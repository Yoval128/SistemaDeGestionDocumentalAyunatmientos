...
class HistoricoController extends Controller
{
    ...
    {
        return view('historico.historico_index')->with(['historicos' => Historico::all()]);
    }
    public function historico_alta()
    {
        return view('historico.historico_alta');
    }
    ...
    {
        return view('historico.historico_modificacion')->with('historico', $id);
    }
