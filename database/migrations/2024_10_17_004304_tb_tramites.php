...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tb_tramite', function (Blueprint $table) {
            ...
            $table->string('id_area'); // Foránea que enlaza con la tabla de áreas (departamento)
            $table->string('id_usuario');  //Foránea que enlaza con la tabla de usuarios para indicar el responsable
